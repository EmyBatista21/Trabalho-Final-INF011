...
class DiasAteFimValidadeVisitor implements DocumentoVisitor {
    ...
    public void visitCPF(CPF cpf) {
        // Lógica específica para calcular a quantidade de dias até o fim da validade do CPF
        LocalDate fimValidade = cpf.getDataFimValidade(); // Substitua com a lógica real
    ...
    public void visitRG(Rg rg) {
        ...
        LocalDate fimValidade = rg.getDataFimValidade(); // Substitua com a lógica real
        long diasAteFimValidade = ChronoUnit.DAYS.between(hoje, fimValidade);
